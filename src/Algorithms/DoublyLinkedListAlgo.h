#ifndef ALGORITHMS_DOUBLYLINKEDLISTALGO_H
#define ALGORITHMS_DOUBLYLINKEDLISTALGO_H
...
class DoublyLinkedListAlgo : public Algorithm {
public:
    static constexpr int MAX_DS_SIZE = 7;

public:
    DoublyLinkedListAlgo(Visualization& visualization);
...
#endif // ALGORITHMS_DOUBLYLINKEDLISTALGO_H
